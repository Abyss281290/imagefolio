 ...
 */
class ModelsPackagesReports extends CActiveRecord
{
		public $package_views;
		public $sender_filter;
	/**
	 * Returns the static model of the specified AR class.
	 * @return ModelsPackagesReports the static model class
	 */
	...
	{
		return 'agency_models_packages_reports';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'recipients' => array(self::HAS_MANY, 'ModelsPackagesReportsRecipients', 'report_id')
		);
	}
	...
	{
		return AgencyModule::getUser($this->sender_role, $this->sender_user_id);
	}
	
	public function beforeSave()
	{
		$user = Yii::app()->user;
		$this->sender_role = $user->role;
