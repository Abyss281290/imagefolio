...
<div class="admin-image-gallery">
	<div class="row buttons" style="margin-bottom: 10px">
		...
		if($model->images): ?>
			...
			echo CHtml::link(
						...
						$this->createUrl('/agency/models/admin/createMinibook',array('model_id'=>$model->item_id, 'type' => '0')),
	...
	<fieldset class="images gallery"><legend>Gallery (<?php echo count($model->images); ?>)</legend>
		<ul class="notations">
	...
	<fieldset class="upload"><legend>Upload (<?php echo $this->module->imagesLimitPerGallery;//$imagesLeft = $this->module->imagesLimitPerGallery - count($model->images); 	//commenting it for now 	?>)</legend>
		<div id="upload_container"<?php // if(!$imagesLeft) echo ' style="display:none"'; ?>>
			<ul class="files" id="files">
			<?php for($i=0; $i<$this->module->imagesLimitPerGallery; $i++): ?>
				<li>
	...
	<div id="upload-limit-error">
		You reached the image uploading limit (Max: <?php echo $this->module->imagesLimitPerGallery; ?>)
	</div>
	-->
	<?php // endif; ?>
	</fieldset>
