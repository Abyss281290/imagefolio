...
$types = AgencyTypes::model()->findAll('active=1');
$menus1 = array();
$i = 0;
foreach($menus as $menu) {
	...
	if($menu->parent_id == 0)
		$menus1[] = array($menu->type->id, $menu->type->title);
	else
		$menus2[$menu->parent_id][] = array($menu->type->id, $menu->type->title);
	$i++;
}
/*echo '<pre>';
...
<table style="width:auto">
	...
	<tr>
		<td class="list source">
			<?php echo CHtml::dropDownList('firstSelect', null, CHtml::listData($types,'id','title'), array(
				'multiple'=>true,
			)); ?>
		</td>
		<td class="buttons">
