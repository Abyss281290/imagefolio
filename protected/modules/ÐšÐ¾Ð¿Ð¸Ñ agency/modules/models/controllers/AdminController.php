...
class AdminController extends CAdminController
{
	public function accessRules()
	{
		return array(
			...
			array('allow',
				'actions'=>array('update','delete','video','videoRemove','changeActivity','ajaxLoadCharacteristics'),
				'roles'=>array('agency', 'booker'),
	...
	public function actionAjaxLoadCharacteristics($model_id, $type_id, $type2_id)
	{
