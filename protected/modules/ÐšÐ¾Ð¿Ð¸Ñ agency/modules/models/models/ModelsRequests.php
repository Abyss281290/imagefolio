...
class ModelsRequests extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email', 'email'),
			array('type_values, type2_values, created_time', 'safe'),
			...
			array('image_head_shot','file','types'=>'jpeg, jpg, png, gif, tif, bmp','maxFiles'=>1,'maxSize'=>2*1024*1024,'allowEmpty'=>$this->scenario!='insert'),
			array('image_mid_length','file','types'=>'jpeg, jpg, png, gif, tif, bmp','maxFiles'=>1,'maxSize'=>2*1024*1024,'allowEmpty'=>$this->scenario!='insert'),
			array('image_full_length','file','types'=>'jpeg, jpg, png, gif, tif, bmp','maxFiles'=>1,'maxSize'=>2*1024*1024,'allowEmpty'=>$this->scenario!='insert'),
