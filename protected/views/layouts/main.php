...
<body>
  ...
  <!-- Wrapper Start //-->  
    ...
    <div class="footerbox col-24 first">
      <p>Copyright &copy; <?php echo date('Y'); ?> <?php echo CHtml::encode(Yii::app()->params['developerTitle']); ?></p>
    ...
    <div class="footerbox col-14 last">
      <p>&nbsp; <a href="<?php echo $this->createUrl('/site/page/view/terms'); ?>">Terms  of Service</a> &nbsp; •  &nbsp;<a href="<?php echo $this->createUrl('/site/page/view/privacy'); ?>">Privacy Statement</a></p>
      </div> 
