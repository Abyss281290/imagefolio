...
lacerat turpis ras sit amet arcu</p>
			...
			<li id="about_us">
				<div class="alpha grid_5">
					...
					<p>This system has been developed for over more than 10 years with some of the biggest names in the Industry.</p>

<p>The systems management pages have been developed to be as intuitive and fast to use as possible, leveraging modern database and interface design.</p>

<p>ImageFolio.net has no requirements for an agency beyond any computer with internet access.
</p>
<a href="#!/readmore" class="btn">read more</a>
				</div>
