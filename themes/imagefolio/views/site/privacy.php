<h2><span class="red">Privacy</span> Policy</h2>
<div class="scroll">
	<div>
...
<div class="wysiwyg-content">
	<ul>
		<li>
			<p style="display: inline-block; vertical-align: top">To personalize your experience<br>
	(your information helps us to better respond to your individual needs)</p>
		</li>

		<li>
			<p style="display: inline-block; vertical-align: top">To improve our website<br>
	(we continually strive to improve our website offerings based on the information and feedback we receive from you)</p>
		</li>

		<li>
			<p style="display: inline-block; vertical-align: top">To improve customer service<br>
	(your information helps us to more effectively respond to your customer service requests and support needs)</p>
		</li>

		<li>
			<p style="display: inline-block; vertical-align: top">To process transactions<br>
	Your information, whether public or private, will not be sold, exchanged, transferred, or given to any other company for any reason whatsoever, without your consent, other than for the express purpose of delivering the purchased product or service requested.</p>
		...
		<li>
			<p style="display: inline-block; vertical-align: top">To administer a contest, promotion, survey or other site feature</p>
		</li>


		<li>
			<p style="display: inline-block; vertical-align: top">To send periodic emails<br>
	The email address you provide for order processing, may be used to send you information and updates pertaining to your order, in addition to receiving occasional company news, updates,<br> related product or service information, etc.<br>
...
<h3>Do we disclose any information to outside parties? 
</h3>
...
<p>Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at www.imagefolio.net</p>
...
<p>This policy was last modified on 1st April 2011</p>

<h3>Contacting Us </h3>

<p>If there are any questions regarding this privacy policy you may contact us by any of the means indicated on the <a href="http://beta.imagefolio.net/#!/contacts">Contact Us page</a></p>
	
	<!--
		<h3>latrsase miertasem lertyasera mias</h3>
		...
		<p>Varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem. Maecenas tristique orci ac sem. Duis ultricies pharetra magna. Donec accumsan malesuada orci. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. Sed laoreet aliquam leo. </p>
		<p><a href="#" class="red und">privacy@demolink.org</a></p>
		<h3>latrsase miertasem lertyasera mias</h3>
		<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem. Maecenas tristique orci ac sem. Duis ultricies pharetra magna. Donec accumsan malesuada orci. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. Sed laoreet aliquam leo. </p>
		<h3>Sed ut perspiciatis unde omnis iste natus error</h3>
		<p>Varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem. Maecenas tristique orci ac sem. Duis ultricies pharetra magna. Donec accumsan malesuada orci. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. Sed laoreet aliquam leo. </p>
		<a href="#" class="red und">privacy@demolink.org</a>
	-->	
	</div>					
</div>
